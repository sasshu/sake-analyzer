    ...
    <div class="container">
      ...
      <div class="basic-search">      <!-- メインの検索対象の入力 -->
        ...
        <div class="property-search">     <!-- 検索対象 = 成分 -->
          <div class="x-axis">      <!-- x軸 -->
            <p>x軸（横方向）</p>
            <label class="check"><input class="element main" type="radio" name="x-target" value="sakeMeterValue" onclick="sRadio(this)">日本酒度</label>
            <label class="check"><input class="element main" type="radio" name="x-target" value="acidRate" onclick="sRadio(this)">酸度</label>
            <label class="check"><input class="element main" type="radio" name="x-target" value="aminoAcidRate" onclick="sRadio(this)">アミノ酸度</label>
            <label class="check"><input class="element main" type="radio" name="x-target" value="alcoholContent" onclick="sRadio(this)">アルコール度</label>
          </div>
          <div class="y-axis">
            <p>y軸（縦方向）</p>      <!-- y軸 -->
            <label class="check"><input class="element main" type="radio" name="y-target" value="sakeMeterValue" onclick="sRadio(this)">日本酒度</label>
            <label class="check"><input class="element main" type="radio" name="y-target" value="acidRate" onclick="sRadio(this)">酸度</label>
            <label class="check"><input class="element main" type="radio" name="y-target" value="aminoAcidRate" onclick="sRadio(this)">アミノ酸度</label>
            <label class="check"><input class="element main" type="radio" name="y-target" value="alcoholContent" onclick="sRadio(this)">アルコール度</label>
          </div>
        </div>
      </div>
